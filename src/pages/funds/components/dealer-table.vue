<template>
  <div>
    <el-card class="box-card">
      <el-form :inline="true" :model="form" class="demo-form-inline" size="small">
        <el-form-item label="关键字查询">
          <el-input v-model="form.keyword" style="width:220px;" placeholder="券商ID/券商名称/客户端版本号"></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <div class="table">
        <div class="table-top-btn">
          <el-row class="text-right">
            <el-button type="primary" size="small" @click="editInfo({id:0})" plain>添加券商</el-button>
          </el-row>
        </div>
        <el-table
          v-loading="loading"
    ...
    <editInfoDialog :info='detail' :getDate='getFundsDealerInstitutionsList' ref="editInfoDialog"></editInfoDialog> 
  </div>
...
import editInfoDialog from './dealer-edit'
...
export default {
  ...
  created () {},
  mounted () {
    this.getFundsDealerInstitutionsList()
  },
  methods: {
    onSubmit () {
      // 查询表格
    ...
    async getFundsDealerInstitutionsList () {
      let opts = {
