  ...
  <div>
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="positionType" label="账户类型">
        ...
        <el-table-column prop="positionSn" width="170px" label="持仓订单号">
          <template slot-scope="scope">
        ...
        <el-table-column prop="nickName" width="100px" label="用户名/id">
          <template slot-scope="scope">
            <span>{{ scope.row.nickName }}/{{ scope.row.userId }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="stockName" width="160px" label="股票名称">
          <template slot-scope="scope">
            <p>
              <span
                :class="
        ...
        <el-table-column prop="profitAndLose" label="浮动盈亏">
          <template slot-scope="scope">
            <p class="bounceIn">
              <span :class="scope.row.profitAndLose < 0 ? 'green' : 'red'">{{
        ...
        <el-table-column prop="allProfitAndLose" label="总盈亏">
          <template slot-scope="scope">
            <p class="bounceIn">
              <span :class="scope.row.allProfitAndLose < 0 ? 'green' : 'red'">{{
        ...
        <el-table-column prop="sellOrderPrice" label="卖价"> </el-table-column>
        <!-- <el-table-column
         prop="orderFee"
         label="手续费">
       </el-table-column>
       ...
       <el-table-column
        ...
        <el-table-column fixed="right" prop="isLock" width="200px" label="操作">
          <template slot-scope="scope">
            <el-button
              type="primary"
              plain
            ...
            <el-button
              ...
              >删除{{$store.state.showMenu}}</el-button
            >
          </template>
        </el-table-column>
      </el-table>
  ...
  methods: {
    ...
    onExport() {
      require.ensure([], () => {
        ...
        export_json_to_excel(tHeader, data, "融资平仓单" + year + month + day);
      });
    },
    async getAgentList() {
      // 获取下级代理数据
