<template>
  <div>
    <div ref="myEchart" style="height:200px;"></div>
  </div>
        ...
        series: [
          {
            ...
            data: [
              { value: this_.info.orderAllAmt, name: '总金额' },
              { value: this_.info.orderFeeAmt, name: '总费用' },
              { value: this_.info.orderProfitAndLose, name: '总盈亏' }
            ]
          }
        ]
      }
